...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # helper to force the state of the string
        def my_str(s):
            if s is None:
                return 'None'
            else:
        ...
        state = my_str(waypoint) + "_" + inputs['light'] + "_" + my_str(inputs['left']) + "_" + my_str(inputs['oncoming'])
        if self.learning:             
    ...
    def get_maxQ(self, state):
        """ The get_max_Q function is called when the agent is asked to find the
            maximum Q-value of all actions based on the 'state' the smartcab is
            in. """
    ...
    def choose_action(self, state):
        """ The choose_action function is called when the agent is asked to
        choose which action to take, based on the 'state' the smartcab is in.
        """
    ...
    def learn(self, state, action, reward):
        """ The learn function is called after the agent completes an action
        and receives an award. This function does not consider future rewards
...
def run():
    ...
    #   simulation
    #   num_dummies - discrete number of dummy agents in the
    #   environment, default is 100
    ...
    # Flags:
    #   update_delay - continuous time (in seconds) between actions, default
    #   is 2.0 seconds
